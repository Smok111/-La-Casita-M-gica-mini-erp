package com.magichouse.exception;
...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<CustomErrorTemplate> handleDataIntegrityException(org.springframework.dao.DataIntegrityViolationException ex, WebRequest request) {
        CustomErrorTemplate error = new CustomErrorTemplate(
                LocalDateTime.now(),
                "No se puede eliminar porque este registro tiene datos asociados.",
                request.getDescription(false)
        );
